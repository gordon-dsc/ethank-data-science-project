...
Download S&P 500 historical P/E ratios from Macrotrends. Used the 20 year option and then selected the date range under inspection

```{r}
#url of macrotrends website
macrotrends_url <- "https://www.macrotrends.net/2577/sp-500-pe-ratio-price-to-earnings-chart"

#start and end date
start_date <- make_date(year = "2015", month = "1", day = "1")
end_date <- make_date(year = "2024", month = "12", day = "31")

#load in data file to Rstudio
read_csv("../data/imported_data/pe_data.csv",
         skip = 15) |>
  filter(date >= start_date) -> pe_ratio
